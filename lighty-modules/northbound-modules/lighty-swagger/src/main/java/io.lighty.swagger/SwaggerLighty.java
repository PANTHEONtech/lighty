...
import io.lighty.swagger.service.ApiDocServiceDraft02;
import io.lighty.swagger.service.ApiDocServiceRFC8040;
...
public class SwaggerLighty extends AbstractLightyModule {
     ...
     * URLs available for DRAFT_02
     * - Swagger URL: http(s)://{hostname:port}/apidoc/apis
     * - Swagger  UI: http(s)://{hostname:port}/apidoc/explorer/index.html
     * URLs available for DRAFT_18
     * - Swagger URL: http(s)://{hostname:port}/apidoc/18/apis
     * - Swagger  UI: http(s)://{hostname:port}/apidoc/18/explorer/index.html
    ...
    protected boolean initProcedure() {
        ...
        Optional<String> basePath = Optional.of(basePathString);

        switch (restConfConfiguration.getJsonRestconfServiceType()) {
            case DRAFT_02: {
                mountPointSwaggerGeneratorDraft02 =
                        new MountPointSwaggerGeneratorDraft02(lightyServices.getDOMSchemaService(), lightyServices.getControllerDOMMountPointService(), basePath);
                ApiDocGeneratorDraftO2 apiDocGeneratorDraft02 = new ApiDocGeneratorDraftO2(lightyServices.getDOMSchemaService(), basePath);
                ApiDocServiceDraft02 apiDocService = new ApiDocServiceDraft02(mountPointSwaggerGeneratorDraft02, apiDocGeneratorDraft02);
            ...
            case DRAFT_18: {
                mountPointSwaggerGeneratorRFC8040 =
                        new MountPointSwaggerGeneratorRFC8040(lightyServices.getDOMSchemaService(), lightyServices.getControllerDOMMountPointService(),basePath);
                ApiDocGeneratorRFC8040 apiDocGeneratorRFC8040 = new ApiDocGeneratorRFC8040(lightyServices.getDOMSchemaService(), basePath);
    ...
    /**
     * Shuts down swagger.
     * @return true if swagger shutdown was successful.
     */
    @Override
