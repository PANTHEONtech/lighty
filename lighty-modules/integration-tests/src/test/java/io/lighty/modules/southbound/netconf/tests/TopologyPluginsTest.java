...
public class TopologyPluginsTest {
    ...
    public void testMountDevice() throws Exception {
        ...
        final NetconfNode netconfNode = new NetconfNodeBuilder()
                ...
                .setTcpOnly(false)
                .build();
        final NetconfNodeAugment nodeAugment = new NetconfNodeAugmentBuilder().setNetconfNode(netconfNode).build();
        final NodeKey nodeKey = new NodeKey(nodeId);
        final Node node = new NodeBuilder()
                .setNodeId(nodeId)
                .addAugmentation(nodeAugment)
                .build();
        ...
        writeTransaction.mergeParentStructurePut(LogicalDatastoreType.CONFIGURATION, path.toIdentifier(), node);
