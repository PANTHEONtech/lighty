...
abstract class OpenApiLightyTest extends OpenApiLightyTestBase {
    ...
    void testGetDocByModule(UriInfo uriInfo, String modelName, String revisionDate) throws IOException {
        assertSuccessResponse(getJaxRsOpenapi().getDocByModule(
            modelName, revisionDate, uriInfo, mockHttpHeaders(), 0, 0));
    }
    ...
    void testGetApiExplorer(UriInfo uriInfo) {
        ...
        Assertions.assertEquals(redirectCode, response.getStatus());
    }
