...
public class NetconfBaseServiceTest extends NetconfBaseServiceBaseTest {
    ...
    public void testBaseServiceGetMock() {
        ...
        assertNotNull(getSpecificElementSubtree(filter,
    ...
    public void testBaseServiceGetConfigMock() {
        ...
        assertNotNull(getElement);
        Element filter = getSpecificElementSubtree(getElement,
                QNAME_BASE.getNamespace().toString(), "filter");
        assertNotNull(filter);
        assertNotNull(getSpecificElementSubtree(filter,
                NetconfState.QNAME.getNamespace().toString(), "netconf-state"));

        Element sourceElement = getSpecificElementSubtree(getElement,
                QNAME_BASE.getNamespace().toString(), "source");
        assertNotNull(sourceElement);
        assertNotNull(getSpecificElementSubtree(sourceElement,
                QNAME_BASE.getNamespace().toString(), "running"));
    }
    ...
    public void testBaseServiceEditConfigMock() {
        ...
        assertNotNull(getSpecificElementSubtree(editData,
                QNAME_BASE.getNamespace().toString(), "target"));
        assertNotNull(getSpecificElementSubtree(editData,
                QNAME_BASE.getNamespace().toString(), "default-operation"));
        assertNotNull(getSpecificElementSubtree(editData,
                QNAME_BASE.getNamespace().toString(), "error-option"));
        Element config = getSpecificElementSubtree(editData,
                QNAME_BASE.getNamespace().toString(), "config");
        assertNotNull(config);
        final Element netconfStateElement = getSpecificElementSubtree(config,
                NetconfState.QNAME.getNamespace().toString(), "netconf-state");
        assertNotNull(netconfStateElement);
        final Element schemasElement = getSpecificElementSubtree(netconfStateElement,
                NetconfState.QNAME.getNamespace().toString(), "schemas");
        assertNotNull(schemasElement);
        final Element schemaElement = getSpecificElementSubtree(schemasElement,
                NetconfState.QNAME.getNamespace().toString(), "schema");
        assertNotNull(schemaElement);
        final Element versionElement = getSpecificElementSubtree(schemaElement,
                NetconfState.QNAME.getNamespace().toString(), "version");
