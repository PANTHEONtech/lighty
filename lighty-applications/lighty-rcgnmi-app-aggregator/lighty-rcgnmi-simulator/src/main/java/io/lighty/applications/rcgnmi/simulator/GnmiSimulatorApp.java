...
package io.lighty.applications.rcgnmi.simulator;
...
public class GnmiSimulatorApp {
    private static final String DEVICE_ADDRESS = "0.0.0.0";
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String folderWithResources = Arrays.stream(args).findFirst()
            .orElse("/home/cali/DEVELOPMENT/github/lighty/lighty-applications/lighty-rcgnmi-app-aggregator/"
                + "lighty-rcgnmi-simulator/src/main/assembly/resources");
