...
public class UnreachableListener extends AbstractActor {
    ...
    public UnreachableListener(final ActorSystem actorSystem, final DataBroker dataBroker,
        ...
        LOG.info("UnreachableListener was created");
    ...
    private void sendRestartRequest(Member unreachableMember, String unreachablePodName) {
        ...
        try (CloseableHttpClient httpClient = getHttpClient();
             CloseableHttpResponse response = httpClient.execute(buildHttpRequest(new HttpDelete(uriBuilder.build())))) {
    ...
    private HttpRequestBase buildHttpRequest(HttpRequestBase request) {
    ...
    private JSONObject getAllLightyPods() {
        ...
        try (CloseableHttpClient httpClient = getHttpClient();
             CloseableHttpResponse response = httpClient.execute(buildHttpRequest(
                     new HttpGet(getURIForKubernetesAPICall(K8S_GET_PODS_PATH)
