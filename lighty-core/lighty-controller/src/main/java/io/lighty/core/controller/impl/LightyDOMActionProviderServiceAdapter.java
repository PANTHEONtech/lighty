 ...
 *
 */
class LightyDOMActionProviderServiceAdapter implements org.opendaylight.controller.md.sal.dom.api.DOMActionProviderService {

    private final DOMActionProviderService domActionProviderService;

    LightyDOMActionProviderServiceAdapter(final DOMActionProviderService domActionProviderService) {
