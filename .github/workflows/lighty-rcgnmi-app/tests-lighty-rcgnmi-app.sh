...
java -jar ${GITHUB_WORKSPACE}/lighty-applications/lighty-rcgnmi-app-aggregator/lighty-gnmi-device-simulator/target/lighty-gnmi-device-simulator-24.0.0.jar -c ./simulator/example_config.json > /dev/null 2>&1 &
