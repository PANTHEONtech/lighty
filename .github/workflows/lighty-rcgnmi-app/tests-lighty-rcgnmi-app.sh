...
java -jar ${GITHUB_WORKSPACE}/lighty-modules/lighty-gnmi/lighty-gnmi-device-simulator/target/lighty-gnmi-device-simulator-19.0.0.jar -c ./simulator/example_config.json > /dev/null 2>&1 &
