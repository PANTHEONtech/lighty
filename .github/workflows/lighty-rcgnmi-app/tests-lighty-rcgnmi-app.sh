...
java -jar ${GITHUB_WORKSPACE}/lighty-modules/lighty-gnmi/lighty-gnmi-device-simulator/target/lighty-gnmi-device-simulator-14.2.1.jar -c ./simulator/example_config.json > /dev/null 2>&1 &
