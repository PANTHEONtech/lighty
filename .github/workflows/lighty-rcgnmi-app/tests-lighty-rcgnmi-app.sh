...
java -jar ${GITHUB_WORKSPACE}/lighty-modules/lighty-gnmi/lighty-gnmi-device-simulator/target/lighty-gnmi-device-simulator-20.3.0-SNAPSHOT.jar -c ./simulator/example_config.json > /dev/null 2>&1 &
