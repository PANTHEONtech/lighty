...
public class Arguments {
    ...
    @Parameter(names = {"-n", "--member-ordinal" }, description = "Ordinal number od cluster member: 1 or 2 or 3",
            required = true)
    private Integer memberOrdinal;

    @Parameter(names = {"-k", "--kubernetes-deployment"},
            description = "Type of deployment, default is false if not used.")
