...
* unzip example application bundle ```unzip  lighty-cluster-app-11.0.0-SNAPSHOT-bin.zip```
* make 3 separate instances of this application 
```
cp -a lighty-cluster-app-11.0.0-SNAPSHOT lighty-cluster-app-11.0.0-SNAPSHOT-01
cp -a lighty-cluster-app-11.0.0-SNAPSHOT lighty-cluster-app-11.0.0-SNAPSHOT-02
cp -a lighty-cluster-app-11.0.0-SNAPSHOT lighty-cluster-app-11.0.0-SNAPSHOT-03
```
* start all 3 cluster nodes in separate terminals 
```
cd lighty-cluster-app-11.0.0-SNAPSHOT-01
./start-controller-node-01.sh

cd lighty-cluster-app-11.0.0-SNAPSHOT-02
./start-controller-node-02.sh

cd lighty-cluster-app-11.0.0-SNAPSHOT-03
