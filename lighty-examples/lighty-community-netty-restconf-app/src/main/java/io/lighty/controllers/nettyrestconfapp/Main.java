...
public class Main {
    ...
    private void startLighty(final ControllerConfiguration controllerConfiguration,
        ...
        var aaaConfiguration = AAAConfigUtils.createDefaultAAAConfiguration();
        ...
        var defaultPasswordHashService = new DefaultPasswordHashService(passwordServiceConfig);
        var iidmStore = new H2Store(new IdmLightSimpleConnectionProvider(config), defaultPasswordHashService);

        IdmLightProxy idmLightProxy = new IdmLightProxy(iidmStore, defaultPasswordHashService);

        var aaaWebEnvironment = new AAAWebEnvironment(
        ...
        this.restconf = NettyRestConfBuilder
            ...
            .withWebEnvironment(aaaWebEnvironment)
            .build();
