...
* unzip example application bundle ```unzip lighty-community-netty-restconf-app-23.2.0-SNAPSHOT-bin.zip```
* go to unzipped application directory ```cd lighty-community-netty-restconf-app-23.2.0-SNAPSHOT```
* start the example controller application ```java -jar lighty-community-netty-restconf-app-23.2.0-SNAPSHOT.jar```

### Test example application
Once the example application has been started using the command
```java -jar lighty-community-netty-restconf-app-23.2.0-SNAPSHOT.jar```
