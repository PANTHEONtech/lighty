...
```
unzip ../../lighty-applications/lighty-rcgnmi-app-aggregator/lighty-rcgnmi-app/target/lighty-rcgnmi-app-23.0.0-SNAPSHOT-bin.zip
```
Start application with pre-prepared configuration [example_config.json](example_config.json).
```
java -jar lighty-rcgnmi-app-23.0.0-SNAPSHOT/lighty-rcgnmi-app-23.0.0-SNAPSHOT.jar -c example_config.json
```
...
```
java -jar gnmi-device-simulator-23.0.0-SNAPSHOT.jar -c example_config.json
```
