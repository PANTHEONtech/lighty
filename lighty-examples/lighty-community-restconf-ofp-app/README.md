...
```
java -jar lighty-community-restconf-ofp-app-12.1.2-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-12.1.2-SNAPSHOT.jar sampleConfigSingleNode.json
```
