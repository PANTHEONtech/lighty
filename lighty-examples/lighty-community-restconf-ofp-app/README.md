...
```
java -jar lighty-community-restconf-ofp-app-14.0.1-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-14.0.1-SNAPSHOT.jar sampleConfigSingleNode.json
```
