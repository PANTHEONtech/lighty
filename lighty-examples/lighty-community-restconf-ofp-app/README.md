...
```
java -jar lighty-community-restconf-ofp-app-13.1.0-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-13.1.0-SNAPSHOT.jar sampleConfigSingleNode.json
```
