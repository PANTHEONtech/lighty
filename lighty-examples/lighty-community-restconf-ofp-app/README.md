...
```
java -jar lighty-community-restconf-ofp-app-13.0.2-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-13.0.2-SNAPSHOT.jar sampleConfigSingleNode.json
```
