...
```
java -jar lighty-community-restconf-ofp-app-14.2.0-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-14.2.0-SNAPSHOT.jar sampleConfigSingleNode.json
```
