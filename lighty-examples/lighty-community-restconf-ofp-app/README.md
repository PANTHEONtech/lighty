...
```
java -jar lighty-community-restconf-ofp-app-11.2.3-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-11.2.3-SNAPSHOT.jar sampleConfigSingleNode.json
```
