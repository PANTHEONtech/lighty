...
```
java -jar lighty-community-restconf-ofp-app-12.2.0-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-12.2.0-SNAPSHOT.jar sampleConfigSingleNode.json
```
