...
```
java -jar lighty-community-restconf-ofp-app-14.4.1-SNAPSHOT.jar
```
...
```
java -jar lighty-community-restconf-ofp-app-14.4.1-SNAPSHOT.jar sampleConfigSingleNode.json
```
