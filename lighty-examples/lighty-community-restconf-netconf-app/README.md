...
* unzip example application bundle ```unzip  lighty-community-restconf-netconf-app-13.0.2-bin.zip```
* go to unzipped application directory ```cd lighty-community-restconf-netconf-app-13.0.2```
* start controller example controller application ```java -jar lighty-community-restconf-netconf-app-13.0.2.jar``` 

### Test example application
Once example application has been started using command ```java -jar lighty-community-restconf-netconf-app-13.0.2.jar``` 
...
`java -jar lighty-community-restconf-netconf-app-13.0.2.jar /path/to/singleNodeConfig.json`
