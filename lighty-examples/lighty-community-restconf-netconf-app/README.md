...
* unzip example application bundle ```unzip  lighty-community-restconf-netconf-app-17.0.0-bin.zip```
* go to unzipped application directory ```cd lighty-community-restconf-netconf-app-17.0.0```
* start controller example controller application ```java -jar lighty-community-restconf-netconf-app-17.0.0.jar``` 

### Test example application
Once example application has been started using command ```java -jar lighty-community-restconf-netconf-app-17.0.0.jar``` 
...
`java -jar lighty-community-restconf-netconf-app-17.0.0.jar /path/to/singleNodeConfig.json`
