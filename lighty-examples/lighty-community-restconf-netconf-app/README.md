...
Once example application has been started using command ```java -jar lighty-community-restconf-netconf-app-16.1.0-SNAPSHOT.jar``` 
...
`java -jar lighty-community-restconf-netconf-app-16.1.0-SNAPSHOT.jar /path/to/singleNodeConfig.json`
