...
* unzip example application bundle ```unzip  lighty-community-restconf-netconf-app-22.0.0-SNAPSHOT-bin.zip```
* go to unzipped application directory ```cd lighty-community-restconf-netconf-app-22.0.0-SNAPSHOT```
* start controller example controller application ```java -jar lighty-community-restconf-netconf-app-22.0.0-SNAPSHOT.jar``` 
