...
public class Main {
    ...
    public void start(String[] args, boolean registerShutdownHook) {
        ...
        try {
            ...
            final ObjectRegistration<DOMActionImplementation> domActionRegistration = DOMActionRegistrationUtil
                    .registerDOMAction(lightyController, new DeviceStartActionImpl(),
